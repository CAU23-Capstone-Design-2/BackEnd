...
public class MusicService {
    ...
    //음악 학습 요청
    public void trainMusic(Long userId, RequestMusicTrainDto requestMusicTrainDto, String url) throws IOException, InterruptedException {
        ...
        Music music = musicRepository.save(Music.createMusic(getUserById(userId), title, imgUrl, userId.toString() + '_' + youtubeCode + ".mp3"));
        log.info("\n\nMusic table에 음악 저장하기: " + title + ' ' + imgUrl + ' ' + music.getFileUrl()+ ' ' + music.isTrained());
